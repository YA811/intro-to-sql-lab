...
AND ci.name != 'Città del Vaticano' 
AND ci.name LIKE 'Cit%';          
...
WHERE co.name = 'CountryNameClue5';
...
SELECT ci.name AS city_name, co.name AS country_name, ci.population
FROM cities ci
JOIN countries co ON ci.countrycode = co.code
WHERE ci.population BETWEEN 91000 AND 91085;
